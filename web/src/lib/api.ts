...
const realApi = {
  ...
  chatStream: async (payload: { cwd: string; message: string; model: string; mode: string; resumeId: string; allowedTools?: string[]; images?: ChatImage[]; effort?: "high" | "medium" | "low" }, onEvent: (o: Record<string, unknown>) => void, signal?: AbortSignal) => {
    let res: Response;
...
const demoApi: typeof realApi = {
  ...
  chatStream: async (_payload: { cwd: string; message: string; model: string; mode: string; resumeId: string; allowedTools?: string[]; images?: ChatImage[]; effort?: "high" | "medium" | "low" }, onEvent: (o: Record<string, unknown>) => void) => {
